#!/bin/bash
# Example of gym classic control single-agent reinforcement learning without Inference Server, running on a single machine.
...
policy=tpolicies.net_zoo.gym_classic_control.mlp;
policy_config="{ \
  'use_xla': False, \
  'test': False, \
  'rl': True, \
